    ...
    <Container maxWidth="sm">
      ...
      <section>
        <Typography gutterBottom={true} variant="subtitle1">
          Jaydeep built the Relaxo Music app as an Open Source app. This SERVICE
          is provided by Jaydeep at no cost and is intended for use as is.
          <br />
        ...
        <Typography gutterBottom={true}>
          ...
          <Link href="mailto:jaykatakiya8946@gmail.com" target="self">
            jaykatakiya8946@gmail.com
          </Link>
        </Typography>
      </section>
    </Container>
